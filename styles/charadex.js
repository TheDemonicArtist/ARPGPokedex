...
let optionSorter = (options) => {
    ...
    let defaultOptions = {
        ...
        sheetPage: userOptions.sheetPage ? userOptions.sheetPage : "pokedex",
...
let sheetArrayKeys = (arr) => {
    ...
    if (itemArray.indexOf('shiny1')) itemArray[itemArray.indexOf('shiny1')] = { name: 'shiny1', attr: 'src' };
    if (itemArray.indexOf('shiny2')) itemArray[itemArray.indexOf('shiny2')] = { name: 'shiny2', attr: 'src' };
    if (itemArray.indexOf('shiny3')) itemArray[itemArray.indexOf('shiny3')] = { name: 'shiny3', attr: 'src' };
    if (itemArray.indexOf('shiny4')) itemArray[itemArray.indexOf('shiny4')] = { name: 'shiny4', attr: 'src' };
    if (itemArray.indexOf('shiny5')) itemArray[itemArray.indexOf('shiny5')] = { name: 'shiny5', attr: 'src' };
    if (itemArray.indexOf('shiny6')) itemArray[itemArray.indexOf('shiny6')] = { name: 'shiny6', attr: 'src' };
    if (itemArray.indexOf('shiny7')) itemArray[itemArray.indexOf('shiny7')] = { name: 'shiny7', attr: 'src' };
    if (itemArray.indexOf('shiny8')) itemArray[itemArray.indexOf('shiny8')] = { name: 'shiny8', attr: 'src' };
    if (itemArray.indexOf('shiny9')) itemArray[itemArray.indexOf('shiny9')] = { name: 'shiny9', attr: 'src' };
    if (itemArray.indexOf('shiny10')) itemArray[itemArray.indexOf('shiny10')] = { name: 'shiny10', attr: 'src' };
    if (itemArray.indexOf('shiny11')) itemArray[itemArray.indexOf('shiny11')] = { name: 'shiny11', attr: 'src' };
    if (itemArray.indexOf('shiny12')) itemArray[itemArray.indexOf('shiny12')] = { name: 'shiny12', attr: 'src' };
    return itemArray;
};
...
const pokedex = async (options) => {
    ...
    // Reverse based on preference
    charadexInfo.itemOrder == 'desc' ? sheetArray.reverse() : '';
    ...
    let addDesigns = async () => {
        if ($("#design-gallery").length != 0) {
            if (charadexInfo.numOfDesigns != 0) {
                ...
                // Grab dah sheet
                let designs = await fetchSheet(charadexInfo.pokedexSheetPage);
                ...
                for (var i in selectDesigns) { selectDesigns[i].cardlink = folderURL + "pokedex.html?" + cardKey + "=" + selectDesigns[i][cardKey]; }
